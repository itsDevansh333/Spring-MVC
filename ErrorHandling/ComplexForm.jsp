		...
		<form action="saved" method="post">
			...
			<div class="mb-3">
				<label for="id" class="form-label">ID</label> <input type="text"
					name="Id" class="form-control" id="id" placeholder="Enter your ID"
					required>
			</div>

			<div class="mb-3">
				<label for="dob" class="form-label">Date of Birth</label> <input
					pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-MM-DD" name="DoB"
					type="text" class="form-control" id="dob" required>
			</div>

			<div class="mb-3">
				<label for="courses" class="form-label">Select Courses</label> <select
					name="Course" type="checkbox" id="courses" class="form-select"
					multiple size="5">
					<option>JAVA</option>
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						<input name="address.street" type="text" class="form-controll"
							placeholder="Enter street" />
					</div>
					<div class="form-group">
						<input name="addressn.city" type="text" class="form-controll"
